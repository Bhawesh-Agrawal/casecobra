      ...
      <section className="bg-slate-100 py-24">
        ...
        sm:gap-32">
          ...
          gap-4">
            ...
            <img src="/snake-2.png" alt="snake-2" className="w-24
            order-0 lg-order-2"/>
          </div>

          <div className="mx-auto grid max-w-2xl grid-cols-1
          px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 
          gap-y-16">
            ...
            lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  design. Had the case for two and a half monthg now and {" "}
                  <span className="p-0.5 bg-slate-800 
                  text-white">the image is super clear</span>, on the case I had
            ...
            lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "TI usually keep my phone together with my keys in my pocket and that led to
                  some that led to some pretty heavy scratchmarks on all of my last phone cases.
                  This one, besides a barely noticeable scratch on the corner,{" "}
                  <span className="p-0.5 bg-slate-800 
                  text-white">looks breand new after about half a year</span>
                  . I dig it."
                </p>
              </div>
              <div className="flex gap-4 mt-2">
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            ...
            !leading-tight font-bold text-5xl
            md:text-6xl text-gray-900">
                Upload your photo and get {" "}<span className="relative px-2 bg-green-600
                text-white">
                  your own case
                </span>{" "}now
              </h2>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            grid-cols-2 gap-40">
              ...
              ring-gray-900/10 lg:rounded-2xl">
                <img src="/horse.jpg" alt="" className="rounded-md object-cover
                bg-white shadow-2xl ring-1 ring-gray-900/10 h-full w-full" />
              </div>

              <Phone className="w-60" imgSrc="/horse_phone.jpg"></Phone>
            </div>
          </div>
          ...
          space-y-2 w-fit">
            ...
            <div className="flex justify-center">
              ...
              Create your case now <ArrowRight
               className="h-4 w-4 ml-1.5"></ArrowRight></Link>
            </div>
          </ul>
        </MaxWidthWrapper>
      </section>
