...
import HandleComponent from "@/components/HandlComponent";
...
const DesignConfigurator = ({
  ...
  async function saveConfiguration() {
    try {
      ...
      const { left: conatinerLeft, top: containerTop } =
        containerRef.current!.getBoundingClientRect();

      const leftOffset = caseLeft - conatinerLeft;
  ...
  function base64ToBlob(base64: string, mimeType: string) {
    const byteChracters = atob(base64);
    const byteNumbers = new Array(byteChracters.length);
    for (let i = 0; i < byteChracters.length; i++) {
      byteNumbers[i] = byteChracters.charCodeAt(i);
    }
      ...
      <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="relative flex flex-col gap-3 w-full">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="bg-white z-50 w-full px-1">
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          ...
                          >
                            ...
                            sm:ml-4 sm:mt-0 sm:flex-col sm:text-right"
                            >
        ...
        <div className="w-full px-8 h-16 bg-white">
          ...
          <div className="w-full h-full flex justify-end items-center">
            <div className="w-full felx gap-6 items-center">
